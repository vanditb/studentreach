            ...
            await withTransaction(async (tx) => {
              const [researcher] = await tx<{ id: string }[]>`
                ...
                values (
                  ...
                  ${enrichment.bioSnippet ? `${summaries.bioSummary} ${enrichment.bioSnippet}` : summaries.bioSummary},
                  ...
                  ${verifiedFaculty},
                  ${inferredTitle},
                  ${inferredTitleConfidence},
                  ${trustedTitleSourceUrl},
                  ${author.works_count},
